...
local text = matches[2]
tdcli.createNewChannelChat(text, 1, '@Afraz_TM', (function(b, d) tdcli.addChatMember(d.id_, msg.from.id, 0, dl_cb, nil) end), nil)
   if not lang then 
...
if ((matches[1] == 'Afraz_Bot' and not Clang) or (matches[1] == "افرازـبات" and Clang)) then
